...
public class PifAllListData {
    ...
    public PifAllListData(String apiToken, String title, float pay_price, String change_y, String sum_price, int pifId, float sr_price, String ukTitle, String date, float procent, int type_instrument, String nameCat) {
        this.title = title;
