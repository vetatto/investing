...
public class UKData {
    ...
    public UKData(String apiToken, String title, float date_price, float sum_amount, String sum_price, int pifId, float sr_price, String ukTitle, String date, float procent, int type_instrument, String nameCat, float sum_money) {
        this.title = title;
